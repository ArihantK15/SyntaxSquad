...
// Precision Light (better-design registry) -- browser-extracted from the
// original site (2026). Primary: charcoal near-black #2e2e2e (rgb 46,46,46
// -- same as body text). Radius: 10px default, 13px for xl (CTA size).
// Ring/focus: blue #335cff.
