  ...
  return (
    <div className="flex items-center justify-between gap-3 text-xs text-graphite-500">
      <div className="flex items-center gap-2 min-w-0">
        <ShieldCheck className="w-3.5 h-3.5 text-graphite-600 shrink-0" />
      ...
      <button
        ...
        className="text-graphite-600 hover:text-graphite-400 p-1 rounded transition-colors shrink-0 cursor-pointer"
